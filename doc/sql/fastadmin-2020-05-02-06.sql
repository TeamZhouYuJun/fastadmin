...
-- Records of fa_admin
-- ----------------------------
INSERT INTO `fa_admin` VALUES ('1', 'admin', 'Admin', '843c10aa5e0e538a2c6acc4dc24a2cf8', '4f79e5', '/assets/img/avatar.png', 'admin@admin.com', '0', '1588354896', '127.0.0.1', '1492186163', '1588354896', '0b10fba8-6eb2-4feb-98ee-dc7dc06463c1', 'normal');
...
CREATE TABLE `fa_admin_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT='管理员日志表';
...
CREATE TABLE `fa_job_hunter` (
  ...
  `profession` varchar(32) CHARACTER SET utf8mb4 DEFAULT '' COMMENT '工种',
  `profession_level` tinyint(2) DEFAULT '0' COMMENT '工种等级',
...
-- ----------------------------
INSERT INTO `fa_job_hunter` VALUES ('1', '廖', '廖叉叉', '18', '18676684597', '1', '西大', '计算机科学', '1', '这是我的履历');
